...
const Home: NextPage = () => {
    ...
    const { activePhase, maxSupply, mintingFee, currentEthPrice, totalSupply, balances, loading } = useContractInfo(web3Provider, address, chainId)
    ...
    return (
        <>
            ...
            <main className="flex flex-col w-screen">
                ...
                {loading ? (
                    <div className="w-screen h-screen self-center flex items-center justify-center mt-10">
